Many organizations decide to implement their own messaging protocols using simple files. The best way to achieve this is to create files that the student can open, read and even edit. 

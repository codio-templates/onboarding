If you want to configure your box to your exact needs then the usual process is to create a new project with a stack as close to your intended stack as possible and then modify it.
